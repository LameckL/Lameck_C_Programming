...
/**
 * cd_dot - this func changes to the parent directory
 * @datash: data
 * Return: none
 */
...
/**
 * cd_to - a func to change to a specified directory by the user
 * @datash: data
 * Return: none
 */
...
/**
 * cd_previous - func to change to the previous directory
 * @datash: data
 * Return: none
 */
...
/**
 * cd_to_home - this func changes to home directory
